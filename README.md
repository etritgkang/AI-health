...
project-root
- src/  <br/>
    -- data_loader.py    # API 데이터 수집 및 전처리 파이프라인  <br/>
    -- utils.py          # 공통 유틸리티 함수  <br/>
- .streamlit/  <br/>
    -- secrets.toml      # API Key 보안 관리 (Gitignore 처리)   <br/>
- main.py               # Streamlit 메인 UI 및 대시보드 로직   <br/>
- requirements.txt      # 패키지 의존성 관리   <br/>
- asset/                # (주)라이팅랩스 logo_2     <br/>
